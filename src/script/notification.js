import { PUSH_VAPIDKEY_PUBLIC } from './const';
      ...
      if ('PushManager' in window) {
        ...
        try {
          ...
          const subsctription = await registration.pushManager.subscribe({
            applicationServerKey: urlB64ToUint8Array(PUSH_VAPIDKEY_PUBLIC),
            userVisibleOnly: true,
          });
          
          // Show push subscription
          console.log(`${LOG_LABEL} Enpoint \n${subsctription.endpoint}`);
          console.log(`${LOG_LABEL} p256dh key \n${uInt8ArrayToStr(subsctription.getKey('p256dh'))}`);
